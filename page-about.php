...
<main class="l-main">
      ...
      <div class="p-about__grid">
        ...
        ?>
          <div class="p-about__item">
            <img
              src="<?php echo esc_url( $assets . '/img/about/' . $filename ); ?>"
              alt="企業理念イメージ"
  ...
  <section class="p-about-eaat">
    <div class="p-about-eaat__bg">
      <img
        src="<?php echo esc_url( $assets . '/img/about/about-item1.jpg' ); ?>"
        alt=""
        class="p-about-eaat__bg-image"
        loading="lazy"
        decoding="async"
        fetchpriority="low"
        width="1920"
      ...
      <div class="p-about-history__content">
        <ul class="p-about-history__list">
          ...
          foreach ( $history_items as $item ) :
            ...
            if ( isset( $item['image'] ) ) {
              $image_html = sprintf(
                '<div class="p-about-history__image-wrapper"><img src="%s" alt="店舗写真" class="p-about-history__image" loading="lazy" decoding="async" fetchpriority="low" width="600" height="400"></div>',
                esc_url( $assets . '/img/shop/' . $item['image'] )
              );
            }
          ?>
