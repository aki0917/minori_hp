...
<main class="l-main">  
      ...
      <div class="p-items__content">
        <?php foreach ( $features as $feature ) : ?>
          <article class="p-items__item">
            <img 
              class="p-items__image" 
              src="<?php echo esc_url( $template_uri . '/assets/img/top/' . $feature['image'] ); ?>" 
  ...
  $products = array(
    ...
    array(
      ...
      'link' => 'https://item.rakuten.co.jp/kminori/1008142/',
    ),
    array(
      'image' => 'herbs.jpg',
      'title' => 'ハーブ・ニート',
      ...
      'link' => 'https://item.rakuten.co.jp/kminori/1008901/',
    ),
  );
  ?>
      ...
      <ul class="p-items-card__list">
        <?php foreach ( $products as $product ) : ?>
          <li class="p-items-card__card">
            <img 
              class="p-items__image" 
              src="<?php echo esc_url( $template_uri . '/assets/img/products/' . $product['image'] ); ?>" 
              alt="肥料"
              loading="lazy"
              decoding="async"
              fetchpriority="low"
          ...
          <div class="p-farmers-card__benefit">
            ...
            <div class="p-farmers-card__benefit-content">
              <div class="p-farmers-card__benefit-image">
                <img 
                  src="<?php echo esc_url( $template_uri . '/assets/img/top/mascot.png' ); ?>" 
                  alt="みのりカードマスコット"
                  loading="lazy"
                  decoding="async"
                  fetchpriority="low"
